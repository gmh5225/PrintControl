...
namespace CaasId.src.Domain.Core.SDKLibs
{
    ...
    public struct strings
    {
        ...
        public const string PRINTER_OPTIONS3 = "\\Printer.PrinterOptions3:Read";
        ...
        public const string POWER_DOWN_PRINTER = "\\Printer.PowerDown:Set";
        public const string CLEAN_PRINTER_ACTION = "\\CleanPrinter.Action:Set";
        public const string CLEAN_LAMINATOR_ACTION = "\\CleanLaminator.Action:Set";
        ...
        public const string SUBMIT_SETTINGS = "\\Printer.SubmitSettings:Set";
        ...
        public const string SUBMIT_SETTINGS_XML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
            + "<DPCLSettings:Settings>"
            + "<module name=\"D1\">"
            + "<subsystem name=\"{0}\">"
            + "<element name=\"{1}\">"
            + "<value>{2}</value>"
