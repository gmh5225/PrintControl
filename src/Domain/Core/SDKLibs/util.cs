...
namespace CaasId.src.Domain.Core.SDKLibs
{
    ...
    public class PrinterOptionsValues
    {
        ...
        public string _optionTactileImpresser;
        ...
        public string _rearPickOption;
    }

    public class PrinterOptions3Values
    {
        public string _printerColorMode;
    };
    ...
    public class SuppliesValues
    {
        ...
        public long _tactileImpresserFoilType;
        public short _tactileImpresserFoilRemaining;
        public long _tactileImpresserPartNumber;
        public string _tactileImpresserLotCode;
        public string _tactileImpresserSerialNumber;
    }
    ...
    class Util
    {
            ...
            string hopperId)
        {
            ...
            int hopperNdx = 1;
            int.TryParse(hopperId, out hopperNdx);
            return hopperNdx;
        }
        ...
        public static PrinterOptionsValues ParsePrinterOptionsXML(string printerOptionsXML)
        {
            ...
            // tactile impresser
            printerOptionsValues._optionTactileImpresser = StringFromXml(doc, "PrinterInfo2/TactileImpresser");

            printerOptionsValues._rearPickOption = StringFromXml(doc, "PrinterInfo2/RearPick");
            return printerOptionsValues;
        }

        ////////////////////////////////////////////////////////////////////////////////
        // util::ParsePrinterOptions3XML()
        //
        // parse the xml returned from GetPrinterOptions3XML(). Populate a
        // PrinterOptions3Values data structure with the values and return it.
        //
        // sample xml markup returned from printer sorted by element name:
        //
        //    <?xml version="1.0"?>
        //    <!--Printer options3 xml file.-->
        //    <PrinterInfo3>
        //       <PrinterColorMode>Ready</PrinterColorMode>
        //    </PrinterInfo3>
        //
        ////////////////////////////////////////////////////////////////////////////////
        public static PrinterOptions3Values ParsePrinterOptions3XML(string printerOptions3XML)
        {
            XmlDocument doc = new XmlDocument();
            doc.LoadXml(printerOptions3XML);

            PrinterOptions3Values printerOptions3Values = new PrinterOptions3Values();
            printerOptions3Values._printerColorMode = StringFromXml(doc, "PrinterInfo3/PrinterColorMode");

            return printerOptions3Values;
        }
        ...
        public static SuppliesValues ParseSuppliesXML(string suppliesXML)
        {
            ...
            //     <TactileImpresserFoilType>67174401</TactileImpresserFoilType>
            //     <TactileImpresserFoilRemaining>50</TactileImpresserFoilRemaining>
            //     <TactileImpresserPartNumber></TactileImpresserPartNumber>
            //     <TactileImpresserLotCode></TactileImpresserLotCode>
            //     <TactileImpresserSerialNumber></TactileImpresserSerialNumber>
            //   </TactileImpresser>
            // </PrinterSupplies3>
            ...
            suppliesValues._indentRibbonPartNumber = IntFromXml(doc, "PrinterSupplies3/Embosser/IndentRibbonPartNumber");
            ...
            suppliesValues._laminatorL1PartNumber = IntFromXml(doc, "PrinterSupplies3/Laminator/L1LaminatePartNumber");
            ...
            suppliesValues._laminatorL1SupplyCode = IntFromXml(doc, "PrinterSupplies3/Laminator/L1LaminateType");
            suppliesValues._laminatorL2LotCode = StringFromXml(doc, "PrinterSupplies3/Laminator/L2LaminateLotCode");
            suppliesValues._laminatorL2PartNumber = IntFromXml(doc, "PrinterSupplies3/Laminator/L2LaminatePartNumber");
            ...
            suppliesValues._laminatorL2SupplyCode = IntFromXml(doc, "PrinterSupplies3/Laminator/L2LaminateType");
            ...
            suppliesValues._printRibbonPartNumber = IntFromXml(doc, "PrinterSupplies3/Printer/RibbonPartNumber");
            ...
            suppliesValues._printRibbonRegionCode = IntFromXml(doc, "PrinterSupplies3/Printer/RibbonRegionCode");
            ...
            suppliesValues._topperRibbonPartNumber = IntFromXml(doc, "PrinterSupplies3/Embosser/TopperRibbonPartNumber");
            ...
            suppliesValues._retransferFilmPartNumber = IntFromXml(doc, "PrinterSupplies3/Printer/RetransferFilmPartNumber");
            ...
            // tactile impresser supplies
            suppliesValues._tactileImpresserLotCode = StringFromXml(doc, "PrinterSupplies3/TactileImpresser/TactileImpresserLotCode");
            suppliesValues._tactileImpresserPartNumber = IntFromXml(doc, "PrinterSupplies3/TactileImpresser/TactileImpresserPartNumber");
            suppliesValues._tactileImpresserFoilRemaining = (short)IntFromXml(doc, "PrinterSupplies3/TactileImpresser/TactileImpresserFoilRemaining");
            suppliesValues._tactileImpresserSerialNumber = StringFromXml(doc, "PrinterSupplies3/TactileImpresser/TactileImpresserSerialNumber");
            suppliesValues._tactileImpresserFoilType = IntFromXml(doc, "PrinterSupplies3/TactileImpresser/TactileImpresserFoilType");
        ...
        public static int WaitForWindowsJobID(BidiSplWrap bidiSpl, string printerName)
        {
            ...
            var printerStatus = ParsePrinterStatusXML(printerStatusXML);
            ...
            do
            {
                ...
                printerStatus = ParsePrinterStatusXML(printerStatusXML);
        ...
        static void OnPrintPage(object sender, PrintPageEventArgs pageEventArgs)
        {
            ...
            {
                pageEventArgs.Graphics.DrawRectangle(pen, 20, 30, 20, 25);
                pageEventArgs.Graphics.DrawString("Sample Text", font, brush, 50, 30);
            }
        }
        ...
        static void OnPrintPageWithBlockingEscapes(PrintPageEventArgs pageEventArgs, string printBlockingEscape, string topcoatRemovalEscape)
        {
            ...
            using (Pen pen = new Pen(Color.DarkBlue))
            {
                ...
                {
                    pageEventArgs.Graphics.DrawString(printBlockingEscape, font, brush, 6, 6);
                }
                if (topcoatRemovalEscape.Length > 0)
                {
                    pageEventArgs.Graphics.DrawString(topcoatRemovalEscape, font, brush, 6, 60);
                }
                pageEventArgs.Graphics.DrawString("Sample Text", font, brush, 150, 150);
                pageEventArgs.Graphics.DrawRectangle(pen, 150, 210, 60, 75);
            }
        }
            ...
            string cardEjectSide = "default")
        {
            ...
            do
            {
                ...
                PrinterOptionsValues printerOptionsValues = ParsePrinterOptionsXML(printerOptionsXML);
                ...
                PrinterStatusValues printerStatusValues = ParsePrinterStatusXML(printerStatusXML);
        ...
        public static void PollForJobCompletion(BidiSplWrap bidiSpl, int printerJobID)
        {
            ...
            while (true)
            {
                ...
                JobStatusValues jobStatusValues = ParseJobStatusXML(jobStatusXML);
        ...
        public static extern bool OpenPrinter([MarshalAs(UnmanagedType.LPStr)] string szPrinter, out nint hPrinter,
                                              nint pd);
        ...
        [DllImport("winspool.Drv", EntryPoint = "StartDocPrinterA", SetLastError = true, CharSet = CharSet.Ansi,
          ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        public static extern bool StartDocPrinter(nint hPrinter, int level,
        ...
        //  
        public static bool RawDataToXpsPrinter(string printerName)
        {

            int dwWritten = 0;
            nint lhPrinter;
            bool bStatus = OpenPrinter(printerName, out lhPrinter, new nint(0));
            ...
            if (bStatus)
            {
                ...
                //    "RAW" datatype.
                //
                var rawPrinter = new DOC_INFO_1() { pDocName = "My Document", pDataType = "XPS_PASS", pOutputFile = null };

                bStatus = StartDocPrinter(lhPrinter, 1, rawPrinter);
                ...
                if (bStatus)
                {
                    ...
                    nint unmanagedPointer = Marshal.AllocHGlobal(buffer.Length);
                    Marshal.Copy(buffer, 0, unmanagedPointer, buffer.Length);
                    bStatus = WritePrinter(lhPrinter, unmanagedPointer, buffer.Length, out dwWritten);
                    Marshal.FreeHGlobal(unmanagedPointer);
                }

                // close document
                bStatus = EndDocPrinter(lhPrinter);

                // close printer handle
                bStatus = ClosePrinter(lhPrinter);
            }

            if (!bStatus || 0 != dwWritten)
            {
                bStatus = false;
            }
            else
